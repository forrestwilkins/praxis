...
describe("Top Navigation for Desktop", () => {
  it("should render TopNavDesktop component with log in when user is logged out", async () => {
  ...
  it("should render TopNavDesktop component with sign up and log in when user is logged out and has been invited", async () => {
    mocked(useCurrentUser).mockReturnValueOnce(undefined);
  ...
  it("should render TopNavDesktop component with profile and log out when user is logged in", async () => {
